...
public class BeatSyncableEmitter : FMODUnity.EventHandler
{
    ...
    private static List<BeatSyncableEmitter> activeEmitters = new List<BeatSyncableEmitter>();
    ...
    {
        foreach (BeatSyncableEmitter emitter in activeEmitters)
        {
            emitter.UpdatePlayingStatus();
        }
    }

    private static void RegisterActiveEmitter(BeatSyncableEmitter emitter)
    {
    ...
    private static void DeregisterActiveEmitter(BeatSyncableEmitter emitter)
    {
